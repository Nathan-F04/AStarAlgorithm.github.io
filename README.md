...
For calculations, a double can be more accurate than a float but I felt that given the calculations performed here I did not want to create variables that were taking up twice the size in memory with no benefit. This is the reason why the attributes within the *node* struct are floats.
